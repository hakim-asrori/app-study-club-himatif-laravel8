    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0 " style="z-index: 999">
        <div class="navbar-header bg-primary">
            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                ...
                <li class="dropdown">
                    <a class="profile-pic dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="<?= $user->image != 'default.jpg' ? '/assets/img/profile/'.$user->image : '/assets/img/profile/'.$user->image ?>" alt="user-img" width="36" height="36" class="img-circle"><b class="hidden-xs"><?= Session::get('email') ?> </b></a>
